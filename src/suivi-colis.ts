...
const form: HTMLFormElement = (document.getElementById("form-suivi-colis") as HTMLFormElement);
const textColis: HTMLDivElement = (document.getElementById("err-search-colis-date") as HTMLDivElement);
const code: HTMLInputElement = (document.querySelector("#code") as HTMLInputElement);
...
form.addEventListener('submit', (e: any) =>{
    ...
    if (isValid) {
        const product:Product | undefined = searchProduct(valSearch);
        if (product) {
...
function displayErrorMessage(code: string) {
    resultDiv.innerHTML = '';
    resultDiv.innerHTML = `
...
function searchProduct(code: string): Product | undefined {
