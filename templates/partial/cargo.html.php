...
<div class="overflow-x-auto mt-5">
    ...
    <div class="flex justify-end pr-4 mt-2">
        <button id="prev-page" class="bg-pink-600 text-white px-2 py-1 rounded" type="button">Précédent</button>
            <span id="page-info" class="mx-2"></span>
        <button id="next-page" class="bg-pink-600 text-white px-2 py-1 rounded" type="button">Suivant</button>
    </div>
</div>
...
<div id="detailsModal" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center" style="display:none;">
  <div class="bg-white p-6 rounded shadow-md w-2/3 h-3/4 overflow-auto">
    ...
    <button class="bg-red-500 text-white px-4 py-2 rounded mt-4 details-modal-close" >Fermer</button>
  </div>
</div>
